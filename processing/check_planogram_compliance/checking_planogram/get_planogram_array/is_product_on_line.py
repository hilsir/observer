def is_product_on_line(product, line_x_min, line_x_max, line_y_avg, buffer=20):
    ...
    # Добавляем небольшой y_buffer (20 пикселей), чтобы компенсировать погрешность разметки
