...
class Identification:
    def __init__(self, path_to_model=None):
        ...
        # Path(__file__).resolve().parent — это папка, в которой лежит сам этот скрипт.
        base_path = Path(__file__).resolve().parent
        # заметка (base_path / model_path) соеденяет строки
        model_full_path = (base_path / path_to_model).resolve()
